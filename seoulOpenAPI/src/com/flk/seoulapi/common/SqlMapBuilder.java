...
public abstract class SqlMapBuilder {
	...
	protected static String getQuery(String statemetId, Object parameter, SqlMapClient sqlMapClient){
		String	query	= null;
		Sql		sql		= null;
	...
	protected static void printQuery(String statemetId, Object parameter, SqlMapClient sqlMapClient){
	...
	protected static void printQuery(String statemetId, Object parameter){
