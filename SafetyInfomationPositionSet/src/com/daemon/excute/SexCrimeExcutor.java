/*
 * com.daemon.excute.SexCrimeExcutor
 *
...
public class SexCrimeExcutor implements Executor
{
	private static Logger m_traceLogger = Logger.getLogger("TRACE");
	private ArrayList<SexCrimeVO> list;
	
	public SexCrimeExcutor(ArrayList<SexCrimeVO> list){
		this.list = list;
	}
	/* (non-Javadoc)
	...
	public void execute() throws Exception {
		...
		for(SexCrimeVO obj : list){
			searchText = obj.getArea() + " " + obj.getGu() + " " + obj.getDong();
			...
			ExcuterService.getInstance().setPositionSexCrime(obj);
		}
	}
}
