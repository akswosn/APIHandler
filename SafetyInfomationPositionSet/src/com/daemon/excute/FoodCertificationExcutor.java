/*
 * com.daemon.excute.FoodCertificationExcutor
 *
...
public class FoodCertificationExcutor implements Executor
{
	private static Logger m_traceLogger = Logger.getLogger("TRACE");
	private ArrayList<FoodCertificationVO> list;
	
	public FoodCertificationExcutor(ArrayList<FoodCertificationVO> list){
		this.list = list;
	}
	/* (non-Javadoc)
	...
	public void execute() throws Exception {
		...
		for(FoodCertificationVO obj : list){
			...
			ExcuterService.getInstance().setPositionFoodCertification(obj);
		}
	}
