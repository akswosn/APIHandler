/*
 * com.daemon.excute.CalamityLandslideExcutor
 *
...
public class CalamityLandslideExcutor implements Executor
{
	private static Logger m_traceLogger = Logger.getLogger("TRACE");
	private ArrayList<CalamityLandslideVO> list;
	
	public CalamityLandslideExcutor(ArrayList<CalamityLandslideVO> list){
		this.list = list;
	}
	/* (non-Javadoc)
	...
	public void execute() throws Exception {
		...
		for(CalamityLandslideVO obj : list){
			...
			ExcuterService.getInstance().setPositionCalamityLandslide(obj);
		}
	}
