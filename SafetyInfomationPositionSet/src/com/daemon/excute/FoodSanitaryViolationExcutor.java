/*
 * com.daemon.excute.FoodSanitaryViolationExcutor
 *
...
public class FoodSanitaryViolationExcutor implements Executor
{
	private static Logger m_traceLogger = Logger.getLogger("TRACE");
	private ArrayList<FoodSanitaryViolationVO> list;
	
	public FoodSanitaryViolationExcutor(ArrayList<FoodSanitaryViolationVO> list){
		this.list = list;
	}
	/* (non-Javadoc)
	...
	public void execute() throws Exception {
		...
		for(FoodSanitaryViolationVO obj : list){
			searchText = obj.getLocation();
			...
			ExcuterService.getInstance().setPositionFoodSanitaryViolation(obj);
		}
	}
