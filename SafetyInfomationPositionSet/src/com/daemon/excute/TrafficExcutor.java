/*
 * com.daemon.excute.TrafficExcutor
 *
...
public class TrafficExcutor  implements Executor
{
	private static Logger m_traceLogger = Logger.getLogger("TRACE");
	private ArrayList<TrafficVO> list;
	
	public TrafficExcutor(ArrayList<TrafficVO> list){
		this.list = list;
	}
	/* (non-Javadoc)
	...
	public void execute() throws Exception {
		...
		for(TrafficVO obj : list){
			...
			ExcuterService.getInstance().setPositionTraffic(obj);
		}
	}
}
