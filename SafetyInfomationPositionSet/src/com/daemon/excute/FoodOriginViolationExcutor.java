/*
 * com.daemon.excute.FoodOriginViolationExcutor
 *
...
public class FoodOriginViolationExcutor implements Executor
{
	private static Logger m_traceLogger = Logger.getLogger("TRACE");
	private ArrayList<FoodOriginViolationVO> list;
	
	public FoodOriginViolationExcutor(ArrayList<FoodOriginViolationVO> list){
		this.list = list;
	}
	/* (non-Javadoc)
	...
	public void execute() throws Exception {
		...
		for(FoodOriginViolationVO obj : list){
			searchText = obj.getAddress();
			...
			ExcuterService.getInstance().setPositionFoodOriginViolation(obj);
		}
	}
