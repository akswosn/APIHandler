/*
 * com.daemon.excute.CalamityDisasterExcutor
 *
...
public class CalamityDisasterExcutor implements Executor
{
	private static Logger m_traceLogger = Logger.getLogger("TRACE");
	private ArrayList<CalamityDisasterVO> list;
	
	public CalamityDisasterExcutor(ArrayList<CalamityDisasterVO> list) {
		this.list = list;
	}
	...
	public void execute(){
		...
		for(CalamityDisasterVO obj : list){
			...
			ExcuterService.getInstance().setPositionCalamityDisaster(obj);
		}
	}
}
